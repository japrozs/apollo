...
export type UpdateProfileMutation = { __typename?: 'Mutation', updateProfile: { __typename?: 'UserResponse', errors?: Maybe<Array<{ __typename?: 'FieldError', field: string, message: string }>>, user?: Maybe<{ __typename: 'User', id: number, name: string, theme: string, email: string, bio: string, username: string, createdAt: string, updatedAt: string, avatarUrl: string }> } };
...
export const UpdateProfileDocument = gql`
    mutation updateProfile($bio: String!, $email: String!, $username: String!, $name: String!) {
  updateProfile(bio: $bio, email: $email, username: $username, name: $name) {
    ...RegularUserResponse
  }
}
    ${RegularUserResponseFragmentDoc}`;
